...
<head>
  <meta charset="utf-8">
  <title>Laporan Kehadiran Harian Guru</title>
...
<body class="A4">
  ...
  if (($idKelas ?? 'all') !== 'all') {
     $kelasLabel = trim(($kelasInfo['kelas'] ?? '') . ' ' . ($kelasInfo['jurusan'] ?? ''));
     if ($kelasLabel === '') {
        $kelasLabel = '-';
     }
  }
        ...
        <section class="sheet padding-10mm">
           <div class="kop">
              ...
              <div>
                 ...
                 <p class="subtitle">Laporan Kehadiran Guru/Panitia</p>
              </div>
           </div>
           ...
           <div class="meta-row">
              ...
              <!-- <div class="meta-block">
                 <span class="meta-label">Filter Kelas</span>
                 <span class="meta-value"><?= esc($kelasLabel); ?></span>
              </div> -->
              <div class="meta-block">
                 <span class="meta-label">Filter Kehadiran</span>
                 <span class="meta-value"><?= esc($selectedKehadiran ?? 'Semua kehadiran'); ?></span>
              </div>
           </div>
           ...
           <table class="report">
              ...
              <tbody>
                 <?php foreach ($chunk as $row) : ?>
                    <?php
                    $status = statusKehadiran($row['id_kehadiran'] ?? null);
                    ?>
                    <tr>
  ...
  <?php else : ?>
     <section class="sheet padding-10mm">
        ...
        <div class="empty-state">
           Tidak ada data kehadiran pada filter ini.
        </div>
     </section>
  <?php endif; ?>
