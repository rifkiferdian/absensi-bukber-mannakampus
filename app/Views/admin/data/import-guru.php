                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                            <h4 class="card-title"><b>Bulk Post Upload Panitia</b></h4>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div id="csv_upload_spinner" class="csv-upload-spinner">
                                                <strong class="text-csv-importing">Importing Panitia...</strong>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <div class="card-header card-header-tabs card-header-primary">
                                ...
                                <p class="card-category">documents to generate your Excel file</p>
                            </div>
                            <div class="card-body">
                                <form action="<?= base_url('admin/guru/downloadCSVFilePost'); ?>" method="post">
                                    ...
                                    <button class="btn btn-success btn-block" name="submit" value="xlsx_guru_template">Download Excel Template</button>
                                </form>
                            </div>
                        </div>
                    </div>
