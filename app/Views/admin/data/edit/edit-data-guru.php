                  ...
                  <form action="<?= base_url('admin/guru/edit'); ?>" method="post">
                     ...
                     <div class="form-group mt-4">
                        ...
                        <select id="id_kelas" name="id_kelas" class="form-control <?= $validation->getError('id_kelas') ? 'is-invalid' : ''; ?>">
                           ...
                           <?php
                           $selectedKelas = old('id_kelas') ?? $oldInput['id_kelas'] ?? $data['id_kelas'] ?? '';
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="number" id="hp" name="no_hp" class="form-control <?= $validation->getError('no_hp') ? 'is-invalid' : ''; ?>" placeholder="08969xxx" value="<?= old('no_hp') ?? $oldInput['no_hp']  ?? $data['no_hp'] ?>">
                        <div class="invalid-feedback">
