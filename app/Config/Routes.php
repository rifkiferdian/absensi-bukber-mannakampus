...
$routes->get('data-panitia-public', 'Admin\DataGuru::dataQrGuruPublic');
...
$routes->group('admin', function (RouteCollection $routes) {
   ...
   $routes->post('cetak-report-day', 'Admin\DataAbsenSiswa::cetakReportDay'); // cetak laporan harian
   ...
   $routes->post('cetak-report-day-guru', 'Admin\DataAbsenGuru::cetakReportDay'); // cetak laporan harian guru
